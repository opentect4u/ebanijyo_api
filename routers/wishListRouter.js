...
WishListRouter.get('/', async (req, res) => {
    var user_id = req.query.user_id,
        ...
        select = `a.id cart_id, a.prod_id id, a.user_id, b.prod_name, c.prod_sp, c.discount, d.name cat_name, (SELECT i.img_path FROM td_product_img i WHERE a.prod_id=i.item_id ORDER BY i.id ASC LIMIT 1) img_path, ${stock_select} as stock`,
...
WishListRouter.post('/', async (req, res) => {
    ...
    var table_name = 'td_wishlist',
        fields = flag > 0 ? null :
            '(user_id, prod_id, created_by, created_dt)',
